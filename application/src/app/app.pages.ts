...
import { DeletTripAlertPage } from 'pages/dashboard/components/trips/components/delet-trip-alert/delet-trip-alert';
import { FirstSignsInfoPage } from 'pages/user/join/first-signs-info/first-signs-info';
// import { HelpTutorialPage } from 'pages/help-tutorial/help-tutorial';
// import { TipInfoPage } from 'pages/help-tutorial/components/tip-info/tip-info';

// page components
import { TripAlertPage } from 'pages/dashboard/components/trips/components/trip-alert/trip-alert'
import { CurrentPage } from 'pages/dashboard/components/trips/components/current/current'
import { DealsPage } from 'pages/dashboard/components/deals/deals'
import { TripsPage } from 'pages/dashboard/components/trips/trips'
