...
import { ToastController, AlertController, ActionSheetController, ModalController, Modal, NavParams, NavController, Slides, Toast, Events } from 'ionic-angular';
...
export class ProfileViewPage implements OnInit, OnDestroy {
     ...
     */
    dislikeUser(): void {
        console.log("dislikeUser : A this.currentUserMatchType = ",this.currentUserMatchType)
        ...
        console.log("dislikeUser : B this.currentUserMatchType = ",this.currentUserMatchType)
    }
    ...
    likeUser(): void {
        ...
        console.log("likeUser : A this.currentUserMatchType = ",this.currentUserMatchType)
        ...
        if (this.currentUserMatchType == MatchActionsComponent.TYPE_LIKE && userMatch) {
            ...
            console.log("likeUser : B this.currentUserMatchType = ",this.currentUserMatchType)
            return;
        }

        // like the user
        this.matchActionsComponent.likeUser(this.userId, this.userData.user.userName);
        console.log("likeUser : C this.currentUserMatchType = ",this.currentUserMatchType)
    }
    ...
    private loadUser(): void {
        ...
        this.users.loadFullUserData(this.userId, relations, false).subscribe(() => {
            ...
            this.currentUserMatchType = this.userData.matchAction 
                ...
                console.log("Load : ",this.currentUserMatchType)
