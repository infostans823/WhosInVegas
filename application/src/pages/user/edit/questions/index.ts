...
import { avatars } from 'store/reducers';
...
export class EditUserQuestionsPage extends BaseUserEdit implements OnInit, OnDestroy {
    ...
    private my: any = "";
    private avatarUrl: string = "https://whosinvegas.com/staging/ow_static/plugins/skmobileapp/images/no_avatar_sm.png"
    ...
    itemPhotoGrid: any = [{expanded: false}];
    ...
    ngOnInit(): void {
        ...
        this.myUploadingAvatarSubscription = this.avatars.watchMyUploadingAvatar().subscribe(avatar => {
            ...
            if(!avatar._isPending){
                this.my = avatar
                this.avatarUrl = this.my.pendingUrl
            }
            console.log("this.my 11= ",this.my)
        ...
        this.myAllPhotosSubscription = this.photos.watchMyAllPhotos().subscribe(photos => {
            ...
            // refresh the generated photo list
            this.generatedPhotoList = this.generatePhotoList(true, this.maxPhotos);
            let avatar = this.generatedPhotoList[0]
            this.my = avatar[0]
            this.avatarUrl = this.my.url
    ...
    selectedTabe(tabName){
        this.mSelectedTab = tabName;
    }
